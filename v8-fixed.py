...
start_state[vac_y][vac_x] = start_state[vac_y][vac_x] + "*"
...
def move(vac_x, vac_y):
    
    next_action = random.choice(actions)
    print(next_action)
    
    if next_action == 'u' and vac_y > 0:
        start_state[vac_y][vac_x] = start_state[vac_y][vac_x][0:5]
        vac_y -= 1
        start_state[vac_y][vac_x] = start_state[vac_y][vac_x] + "*"
        ...
        if "Dirty" in start_state[vac_y][vac_x]:
            start_state[vac_y][vac_x] = "Clean"
        if "*" not in start_state[vac_y][vac_x]:
            start_state[vac_y][vac_x] = start_state[vac_y][vac_x] + "*"
